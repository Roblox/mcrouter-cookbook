...
if node['mcrouter']['install_type'] == 'source'
  ...
  package 'double-conversion' do
    version node['mcrouter']['packages']['double-conversion']['version'] if node['mcrouter']['packages']['double-conversion']['version'] # rubocop:disable LineLength
    source node['mcrouter']['packages']['double-conversion']['source'] if node['mcrouter']['packages']['double-conversion']['source'] # rubocop:disable LineLength
    action :install
  end
end
