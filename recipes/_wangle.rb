...
if node['mcrouter']['install_type'] == 'source'
  ...
  package 'wangle' do
    version node['mcrouter']['packages']['wangle']['version'] if node['mcrouter']['packages']['wangle']['version']
    source node['mcrouter']['packages']['wangle']['source'] if node['mcrouter']['packages']['wangle']['source']
    action :install
  end
end
